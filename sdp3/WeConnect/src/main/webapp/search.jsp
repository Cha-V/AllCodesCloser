...
<%@page import="com.klu.demo.dao.CitizenRepo"%>
  ...
  <main id="main" class="main">
    ...
    <section class="section">
      <div class="row">
        ...
        <div class="col-lg-60">
        <% List<Citizen> results = (List<Citizen>)request.getAttribute("result"); 
          ...
          <div class="card">
            <div class="card-body">
					        ...
					        <c:out value="${r.aadhaar   }"></c:out>
					    	<a href="/${r.aadhaar}">Go to Profile</a>
